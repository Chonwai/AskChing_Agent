...
export const MARKET_FIXTURES: readonly MarketObservation[] = [
  ...
  },
  {
    ...
    block: 21_100_000,
    timestamp: '2026-09-08T00:00:00.000Z',
    queryHash: 'sha256:fixture-compound-usdc-utilization',
  },
  ...
  },
  {
    ...
    block: 21_100_050,
    timestamp: '2026-09-08T00:02:30.000Z',
    queryHash: 'sha256:fixture-spark-usdc-utilization',
  },

  {
    ...
    deploymentId: 'fixture:aave-v2-mainnet',
    block: 21_100_070,
    timestamp: '2026-09-08T00:03:30.000Z',
    queryHash: 'sha256:fixture-aave-v2-usdc-supply-apy',
  },
  ...
  },
  {
    ...
    block: 21_100_020,
    timestamp: '2026-09-08T00:01:30.000Z',
    queryHash: 'sha256:fixture-compound-weth-tvl',
  },
] as const;
...
const USDC_HISTORY_SERIES: readonly HistorySeriesSpec[] = [
  {
    ...
    values: [3.8, 3.86, 3.95, 4.02, 4.1, 4.18, 4.25],
  },
  {
    metric: 'supply_apy',
    protocol: 'compound-v3',
    ...
    values: [3.3, 3.26, 3.24, 3.2, 3.18, 3.16, 3.14],
  },
  {
    metric: 'supply_apy',
    protocol: 'spark-lend',
    ...
    values: [2.9, 2.91, 2.92, 2.93, 2.94, 2.95, 2.95],
  },
  {
    metric: 'utilization',
    protocol: 'aave-v3',
