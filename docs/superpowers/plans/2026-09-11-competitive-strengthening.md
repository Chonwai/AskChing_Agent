...
> 「a DeFi research agent that answers natural-language questions like _'which lending markets have the highest USDC supply APY right now?'_ by querying Subgraphs through the Subgraph MCP」
