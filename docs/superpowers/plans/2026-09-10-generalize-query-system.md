...
// ── Metric ──────────────────────────────────────────────────────────
export const MarketMetricIdSchema = z.enum(['supply_apy', 'borrow_apy', 'tvl', 'utilization']);
...
export const LegacyComparisonSchema = z.object({
  ...
  rows: z
    .array(
      ComparisonRowSchema.omit({ asset: true }).extend({ asset: AssetSymbolSchema.optional() }),
    )
    .min(2),
  caveats: z.array(z.string()),
  sources: z
    .array(
      ComparisonSourceSchema.omit({ asset: true }).extend({ asset: AssetSymbolSchema.optional() }),
    )
    .min(2),
});
```
    ...
    .object({
      markets: z.array(
        z.object({
          ...
          rates: z
            .array(z.object({ rate: GraphNumberSchema, side: z.string(), type: z.string() }))
            .nullable(),
...
export const CompareMarketsInputSchema = z
  ...
  .superRefine((val, ctx) => {
    ...
    try {
      AssetSymbolSchema.parse(val.asset.toUpperCase());
    } catch (e) {
...
```typescript
export const RiskScanInputSchema = z
  .object({
      ...
      parameters: {
        ...
        properties: {
          ...
          protocols: {
            ...
            items: {
              type: 'string',
              enum: ['aave-v3', 'compound-v3', 'spark-lend', 'aave-v2', 'uwu-lend', 'zerolend'],
            },
            minItems: 2,
...
export const MARKET_FIXTURES: readonly MarketObservation[] = [
  ...
  },
  {
    ...
    block: 21_100_100,
    timestamp: '2026-09-08T00:05:00.000Z',
    queryHash: 'sha256:fixture-aave-usdc-borrow-apy',
  },
  {
    metric: 'tvl',
    asset: 'USDC',
    ...
    block: 21_100_100,
    timestamp: '2026-09-08T00:05:00.000Z',
    queryHash: 'sha256:fixture-aave-usdc-tvl',
  },
  {
    metric: 'utilization',
    asset: 'USDC',
    ...
    block: 21_100_100,
    timestamp: '2026-09-08T00:05:00.000Z',
    queryHash: 'sha256:fixture-aave-usdc-utilization',
  },
  ...
  },
  {
    ...
    block: 21_100_000,
    timestamp: '2026-09-08T00:00:00.000Z',
    queryHash: 'sha256:fixture-compound-usdc-borrow-apy',
  },
  {
    metric: 'tvl',
    asset: 'USDC',
    ...
    block: 21_100_000,
    timestamp: '2026-09-08T00:00:00.000Z',
    queryHash: 'sha256:fixture-compound-usdc-tvl',
  },
  ...
  // ── USDT ────────────────────────────────────────────────────────
  {
    ...
    deploymentId: 'fixture:aave-v3-mainnet',
    block: 21_100_110,
    timestamp: '2026-09-08T00:06:00.000Z',
    queryHash: 'sha256:fixture-aave-usdt-supply-apy',
  },
  {
    metric: 'supply_apy',
    asset: 'USDT',
    ...
    queryHash: 'sha256:fixture-compound-usdt-supply-apy',
  },
  {
    metric: 'tvl',
    asset: 'USDT',
    ...
    block: 21_100_110,
    timestamp: '2026-09-08T00:06:00.000Z',
    queryHash: 'sha256:fixture-aave-usdt-tvl',
  },
  ...
  // ── DAI ─────────────────────────────────────────────────────────
  {
    ...
    queryHash: 'sha256:fixture-aave-dai-supply-apy',
  },
  {
    metric: 'supply_apy',
    asset: 'DAI',
    ...
    queryHash: 'sha256:fixture-spark-dai-supply-apy',
  },
  ...
  // ── WETH ────────────────────────────────────────────────────────
  {
    ...
    deploymentId: 'fixture:aave-v3-mainnet',
    block: 21_100_130,
    timestamp: '2026-09-08T00:08:00.000Z',
    queryHash: 'sha256:fixture-aave-weth-supply-apy',
  },
  {
    metric: 'supply_apy',
    asset: 'WETH',
    ...
    deploymentId: 'fixture:compound-v3-mainnet',
    block: 21_100_020,
    timestamp: '2026-09-08T00:01:30.000Z',
    queryHash: 'sha256:fixture-compound-weth-supply-apy',
  },
  {
    metric: 'borrow_apy',
    asset: 'WETH',
    ...
    block: 21_100_130,
    timestamp: '2026-09-08T00:08:00.000Z',
    queryHash: 'sha256:fixture-aave-weth-borrow-apy',
  },
  {
    metric: 'tvl',
    asset: 'WETH',
    ...
    block: 21_100_130,
    timestamp: '2026-09-08T00:08:00.000Z',
    queryHash: 'sha256:fixture-aave-weth-tvl',
  },
] as const;
```
